{{-- resources/views/floors/1f.blade.php --}}
{{-- Floor: 1F --}}
{{-- Put ONLY the map blocks here --}}

<!-- LEFT STACK -->
<div class="stairs stairs-left" style="grid-column: 4 / 11; grid-row: 4 / 10; margin: 1.5px;"></div>
...
<div class="stairs stairs-left" style="grid-column: 4 / 11; grid-row: 76 / 82; margin: 1.5px;"></div>
