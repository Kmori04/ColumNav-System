...
<div class="room room-2f-new"
     ...
     data-start-x="9.5" 
     data-start-y="6.0"  
     data-start-thrust="3" {{-- Shortened starting tail --}}
     data-corridor-y="15.2"
...
<div class="room room-2f-new"
     ...
     /* GRID POSITIONING (Horizontal location for the yellow line) */
     data-col-start="71" 
     data-col-end="67"
     data-row-start="1"
     data-row-end="24"
     
     /* PATH GEOMETRY (Matching the backbone of Room 49) */
     data-start-x="38.5" 
     data-start-y="13.3"  
     data-start-thrust="0" 
     data-corridor-y="15.2"
...
<div class="room room-2f-new"
     ...
     /* GRID POSITIONING (Shifted right for Room 51) */
     data-col-start="74" 
     data-col-end="100"
     data-row-start="1"
     data-row-end="24"
     
     /* PATH GEOMETRY (Matching backbone, Start Thrust 0 = no left hook) */
     data-start-x="38.5" 
     data-start-y="13.3"  
     data-start-thrust="0" 
     data-corridor-y="15.2"
...
<div class="room room-2f-new"
     ...
     /* GRID POSITIONING (Shifted right from Room 51's 74/100) */
     data-col-start="100" 
     data-col-end="121"
     data-row-start="1"
     data-row-end="24"
...
<div class="room room-2f-new"
     ...
     /* GRID POSITIONING (Shifted right from Room 53) */
     data-col-start="122" 
     data-col-end="130"
     data-row-start="1"
     data-row-end="24"
     
     /* PATH GEOMETRY (Matching Room 53 Backbone) */
     data-start-x="38.5" 
     data-start-y="13.3"  
     data-start-thrust="0" 
     data-corridor-y="15.2"
...
<div class="room room-2f-new"
     ...
     /* GRID POSITIONING (Shifted right from Room 54) */
     data-col-start="153" 
     data-col-end="130"
     data-row-start="1"
     data-row-end="24"
     
     /* PATH GEOMETRY (Matching Room 53 & 54 Backbone) */
     data-start-x="67.5" 
     data-start-y="13.3"  
     data-start-thrust="0" 
     data-corridor-y="15.2"
...
<div class="room room-2f-new"
     ...
     /* GRID POSITIONING (Shifted right from Room 55) */
     data-col-start="185" 
     data-col-end="135"
     data-row-start="1"
     data-row-end="24"
     
     /* PATH GEOMETRY (Matching Room 53-55 Backbone) */
     data-start-x="67.5" 
     data-start-y="13.3"  
     data-start-thrust="0" 
     data-corridor-y="15.2"
...
<div class="room room-2f-new"
     ...
     /* GRID POSITIONING (Shifted right to align with grid-column 83/89) */
     data-col-start="177" 
     data-col-end="200"
     data-row-start="1"
     data-row-end="21"
     
     /* PATH GEOMETRY (Matching Backbone) */
     data-start-x="67.5" 
     data-start-y="13.3"  
     data-start-thrust="0" 
     data-corridor-y="15.2"
...
<div class="room room-2f-new"
     ...
     /* GRID POSITIONING (Shifted right to align with grid-column 89/97) */
     data-col-start="245" 
     data-col-end="162"
     data-row-start="1"
     data-row-end="21"
     
     /* PATH GEOMETRY (Matching Room 47 Backbone) */
     data-start-x="67.5" 
     data-start-y="13.3"  
     data-start-thrust="0" 
     data-corridor-y="15.2"
